    ...
    public class CitiesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cities != null ? 
                          ...
                          Problem("Entity set 'DblibraryContext.Cities'  is null.");
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            //return View(city);
            return RedirectToAction("Index", "CarServices", new { id = city.Id, name = city.Name });
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DblibraryContext.Cities'  is null.");
            }
            var city = await _context.Cities.FindAsync(id);
            if (city != null)
            {
